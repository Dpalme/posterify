...
export const Navbar = () => {
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-20 flex w-full flex-row items-center justify-evenly gap-2 border-b border-slate-400 bg-white !bg-opacity-75 px-4 py-4 text-black backdrop-blur-md backdrop-filter md:bottom-auto md:top-0 md:justify-start md:gap-8 md:px-12 dark:border-slate-700 dark:bg-slate-800">
      <NavLink to="/">
        <img
          src={Logo}
          alt="Posterify Logo"
